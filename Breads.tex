...
\\ 1 cup lukewarm water
	...
	\\ 2 cups flour
	\\ \nicefrac{3}{4} cup flax bran
	\\ \nicefrac{1}{2} cup oat bran}{Sprinkle yeast over lukewarm water in which 1 Tbsp sugar has been dissolved. Let stand for 10 minutes. Make sponge by adding 2 cups water, salt and whole wheat flour. Let stand for about \nicefrac{3}{4} hour, then mix in flours and knead until smooth. Cover and let rise until double in bulk. Divide in 2 loaves and let rise again to about double in bulk. Then put in cool oven and turn on heat to 325 or 350$^\circ$F and bake 1 hour.}
...
\name{Mom got this recipe from George Pongoski and uses it for all her sweet dough recipes.}\\
...
Place half of the lukewarm water in a bowl. Add yeast and sugar. Ferment. Place flour, milk powder, soft cell, eggs, shortening and salt in mixing bowl. Add yeast mixture. Mix 1 minute. Add remaining water. Mix 10 minutes. Enough for 2 pans of cinnamon rolls.}
...
To prepare pan: spread 1 cup of unmelted butter on pan. Sprinkle approx 1 cup brown sugar (for $9 \times 13$" pan) on bottom of pan. Add \nicefrac{1}{2} cup cream. Stir together to mix.
...
\\ 1 tsp cider vinegar
\\ 2 Tbsp oil
\\ 1 tsp vanilla}{Over low heat, combine butter, sugar and syrup, stirring until sugar dissolves. Add vanilla, whipping cream and salt. Stir. Remove from heat and pour into the bottom of a greased $9 \times 13$" pan with high sides.\par
DOUGH: Mix all dry ingredients until combined. Set aside. Put water and margarine in a glass measuring cup and microwave just until the margarine has melted. Add milk. Stir. Add other wet ingredients and whisk to combine.
...
\name{Always to be eaten with lots of watermelon!!!} \\
...
\name{(EMC Convention in High Level, AB)}\\
\step{1 cup milk
\\ 1 cup cream
\\ 4 eggs
\\ 2 Tbsp salt
...
\name{(from MJ'S Restaurant, Steinbach's fantastic Mennonite restaurant)} \\
	\step{3 cups flour	
	\\ 4 tsp baking powder
	\\ \nicefrac{1}{2} tsp salt	
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CHOCOLATE CHIP BANANA MUFFINS (GF)} \index{CHOCOLATE CHIP BANANA MUFFINS (GF)} \index{Gluten Free!muffins}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CARROT APPLE MUFFINS (GF)} \index{CARROT APPLE MUFFINS (GF)} \index{Gluten Free!muffins}
\step{1 egg \\
\nicefrac{1}{4} cup olive oil \\
\nicefrac{1}{3} cup mashed ripe banana \\
\nicefrac{1}{4} cup maple syrup or honey \\
\nicefrac{1}{2} cup unsweetened applesauce or finely grated apple \\
\nicefrac{1}{2} cup brown sugar \\
\nicefrac{1}{2} tsp salt \\
1 \nicefrac{1}{2} tsp baking soda \\
...
\nicefrac{2}{3} cup GF rolled oats \\
\nicefrac{1}{2} cup almond meal \\
1 heaping cup GF flour \\
\nicefrac{1}{4} cup walnuts}{
Combine egg, banana, maple syrup and oil. Add applesauce, brown sugar, baking soda, salt, cinnamon and combine. Add almond milk and stir. Add carrot and stir. Add remaining ingredients. Divide evenly among 12 muffin tins. Top with crushed walnuts. Bake at 375${}^{\circ}$F for 32--36 minutes until deep golden brown.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BLUEBERRY MUFFINS} \index{BLUEBERRY MUFFINS}
\name{Extra large coffee shop type muffins.}\\
\step{1 \nicefrac{1}{2} cups flour \\
\nicefrac{3}{4} cups sugar \\
\nicefrac{1}{2} tsp salt \\
2 tsp baking powder\\
\nicefrac{1}{3} cup vegetable oil\\
1 egg\\
\nicefrac{1}{3} cup milk, or more as needed\\
1 cup fresh blueberries\\
\nicefrac{1}{3} cup brown sugar\\
2 Tbsp flour\\
\nicefrac{1}{8} tsp cinnamon\\
1 Tbsp butter \\
}{ Combine flour, sugar, baking powder, and salt. Place oil into a 1 cup measuring cup, add egg, and top with milk. Mix into flour mixture. Fold in blueberries. Fill muffin cups. Mix brown sugar, flour, cinnamon, and butter until crumbly. Top muffins. Bake at 400${}^{\circ}$F for 20--25 minutes. Cool 5 minutes before removing from pan. }

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BERRY CREAM MUFFINS} \index{BERRY CREAM MUFFINS}
\name{(Heather Wiebe)}\\
\step{4 cups flour \\
...
1 cup oil \\
1 tsp vanilla extract}{
Combine flour, sugar, baking powder, baking soda and salt. Add berries and toss gently. Combine eggs, sour cream, oil and vanilla. Stir into dry ingredients just until moistened. Fill greased muffin cups two-thirds full. Bake at 400${}^{\circ}$F for 20--25 minutes. Cool 5 minutes before removing from pan.  Yield: 2 dozen. }
...
\\ 2 tsp chopped lemon zest}{Mix until well blended. Divide dough between two 10x5" pans and bake for 40 minutes at 350. Whisk glaze ingredients together. Spoon mixture over loaves while they are still warm and in the pan. Cool and loosen sides with a knife.}
...
\name{(Saskatoon Folkfest Norwegian booth)}\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{YORKSHIRE PUDDING} \index{YORKSHIRE PUDDING}
	...
	\\ 1 \nicefrac{1}{2} cups flour	
	\\ 1 tsp salt}{
Beat eggs. Mix in milk. Beat in flour and salt until bubbly. Pour \nicefrac{1}{4} cup hot droppings from roast into $8 \times 8$" pan. Pour in batter. Bake uncovered in 425$^\circ$F oven until risen and browned, about 30 minutes. Cut into squares to serve.\\
Option: These can be made into popovers by adding 1 Tbsp melted butter to the batter. Pour into well greased muffin tins about \nicefrac{1}{2} full. Place in cold oven. Turn temp to 400${}^\circ$F. Bake for about 40 minutes until puffed and well browned. Makes 12.}
