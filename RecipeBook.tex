...
%\setlrmargins{0.75in}{0.5in}{*}
\setlrmarginsandblock{.5in}{.375in}{*}
\setulmarginsandblock{.625in}{.5in}{*}
...
\newenvironment{ingredients}[1][1em]
  {%
...
%\newenvironment{ingredients}{\raggedright \everycr{\hangindent0.25cm\hangafter1}}{\par}
%[\parindent 0pt]{\hangindent0.25cm\hangafter1}}{\par}

%\newenvironment{ingredients}{\raggedright\everycr{\hangafter=1\hangindent=1em}}{\par}


\newcommand\note[1]{\vspace{0.5em}\noindent\textit{#1}\par}
\newcommand\name[1]{\vspace{0.05em}\noindent\textit{#1}\vspace{0.05em}}
\newcommand\stepspace {\par\vspace{0.5em}}

% Recipe title formatting
%\newcommand\rtitle[1]{\par\vspace{1em}\noindent\textbf{#1}\par}
\newcommand\rtitle[1]{\vspace{0.5em}\noindent\textbf{#1}\par}
% Recipe Formatting
...
%\newcommand\step[2]{\vspace{0.25em}
...
\title{Koehler Recipes} % Book title
\author{Ed. Beth Koehler\\and Katrina Koehler} % Author
