...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SANTA MARIA TRI TIP} \index{SANTA MARIA TRI TIP}
\step{1 tri tip roast	
	...
	\\ 1 tsp dry rosemary
	\\ \nicefrac{1}{2} tsp dry sage	}{Mix dry rub and apply to meat. Let sit for 1 hour. Sear roast 3-4 minutes per side. Cover grill and cook until tri tip reaches 130$^\circ$F (20-40 min). Remove from grill and let it rest in foil for 10 minutes.}
...
\\ 2 bay leaves
\\ 1.5 Tbsp cornstarch}
{Heat pressure cooker on high with Saut\'e button. Pat roast dry, season generously with salt and pepper, and brown roast for 10 minutes on each side. Remove roast. Add oil and saut\'e onions. Add garlic. Add mushrooms. Add wine or balsamic vinegar to deglaze. Add roast and remaining ingredients except cornstarch. Cook on high pressure for 45 minutes. Let it naturally release pressure for 25 minutes. Add cornstarch to make a gravy.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BEEF STEW} \index{BEEF STEW}
\name{(Company's Coming)}\\
\step{
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{TACO CASSEROLE} \index{TACO CASSEROLE}
\name{(Merle Fingas)\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BEEF PATTY CASSEROLE} \index{BEEF PATTY CASSEROLE}
...
1 tsp instant coffee powder}{Grind meats together twice. Soak bread in cream about 5 minutes. Cook onion in 1 Tbsp of butter until tender. Mix meat, crumb mixture, onion, egg, parsley and seasonings. Beat 5 minutes at medium speed with electric mixer. Chill. Shape into 1 \nicefrac{1}{2} inch balls; brown in remaining butter. Remove from skillet. Make gravy. Add meat. Cover. Cook 30 minutes, basting occasionally with gravy.\par
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{MEAT LOAF} \index{MEAT LOAF}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CABBAGE ROLLS (HOLUBSCHI)} \index{CABBAGE ROLLS} \index{HOLUBSCHI}
\step{1 large head cabbage
\\ 1 \nicefrac{1}{2} lbs hamburger
\\ 1 cup cooked rice
\\ 1 med onion, chopped and saut\'ed
\\ Salt and pepper to taste
\\ 1 large tin tomato sauce}{Place cabbage in boiling water and peel off leaves as they become tender.  Set aside.  Combine onions, meat, rice and seasoning. Blend well. Place a spoonful of meat on a cabbage leaf. Roll up and secure. Place in greased casserole. Repeat until all the meat mixture has been used.  Pour tomato sauce over all. Bake in 350${}^\circ$F oven for 2--3 hours or until the cabbage is very tender.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{PORK CHOPS WITH POTATOES} \index{PORK CHOPS WITH POTATOES}
\step{4 pork chops\\
...
1 cup sour cream}{
If not already tenderized, place meat between sheets of waxed paper and pound to a \nicefrac{1}{4} in thickness. Snip edges to prevent curling. Fork beat egg and milk. Mix crumbs and spices. Dip meat into egg mixture then into crumbs. Fry, browning both sides until no pink remains. Spoon Dill Sauce over top or serve on the side.\par
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{PULLED PORK} \index{PULLED PORK} 
\step{1 tsp oil \\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{PORK AND RED CABBAGE CASSEROLE} \index{PORK AND RED CABBAGE CASSEROLE}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{NEW MEXICAN RED ENCHILADAS} \index{NEW MEXICAN RED ENCHILADAS}
\name{(Ray Martinez)}
\step{12 corn tortillas \\
pinto beans \\
4 cups of enchilada sauce \\
Shredded cheese \\
small onion, diced \\
\stepspace ENCHILADA SAUCE:\\
1--1.5 lbs pork, ground or finely chopped\\
\nicefrac{1}{2} cup red onion, diced\\
1 Tbsp garlic, minced\\
\nicefrac{1}{2} cup oil\\
\nicefrac{1}{2} cup flour\\
\nicefrac{1}{2} cup Chimayo red chile powder\\
}{Brown pork, onion, and garlic. For roux, heat oil on medium high, add flour and mix thoroughly with oil. Sprinkle red chile powder until you form a soupy paste. Add roux to meat. Add 2 cups of water. Bring to a boil. Add another 1--2 cups of water as it thickens. Add salt. Red chile with meat can be frozen or assembled into enchilada and then frozen. Fry 12 tortillas until slightly stiff. Assemble enchiladas with 6 tortillas, juice from pinto beans, pinto beans, 2 cups of enchilada sauce, shredded cheese, and onions. Repeat all steps for the second layer without the onions. Bake at 350$^\circ$F until liquid bubbles on the edges.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GARLIC CHICKEN} \index{GARLIC CHICKEN}
\name{(Erma Penner)}\\
...
\\ 1 tsp salt
\\ \nicefrac{1}{4} tsp pepper
}{Put flour and spices in bag. Shake to mix. Put damp chicken pieces in bag. Shake to coat. Brown chicken in butter. Transfer to casserole or small roaster. Pour gravy over chicken. Cover. Bake at 350${}^\circ$F for 1 hour.\par
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BUBBAT} \index{BUBBAT}
 \name{(Loraine Hiebert)}\\
\step{1 cup flour	\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SALMON AND LEEKS} \index{SALMON AND LEEKS}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{TATER TOT CASSEROLE} \index{TATER TOT CASSEROLE}
\step{1 kg bag frozen tater tots	
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GARLIC MASHED POTATOES} \index{GARLIC MASHED POTATOES}
...
Boil potatoes. Drain. Beat potatoes on low speed. Add all ingredients except milk and basil. Gradually beat in enough milk to make fluffy. Spoon into greased 2 quart casserole. Cover and chill up to 24 hours.
Bake, covered, at 325$^\circ$F for 45 minutes. Stir sprinkle with parmesan cheese. Bake 30--45 minutes more or until heated through.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{PINTO BEANS} \index{PINTO BEANS}
\step{2 cups dry pinto beans \\
\nicefrac{1}{4} cup salt pork, cubed}{Cook in a crockpot until beans are tender.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GREEN BEAN ALMONDINE} \index{GREEN BEAN ALMONDINE}
\name{(Jeanie Little)} \\
\step{2 lb fresh green beans \\
\nicefrac{1}{2} cup slivered almonds \\
3 Tbsp butter \\
Salt and pepper \\
}{Boil green beans in salted water or 5 minutes to blanch. Drain and rinse immediately with cold water. Set aside. Toast nuts in butter until medium brown. Combine.}
...
\begin{minipage}{\linewidth}\rtitle{AMISH BREAKFAST CASSEROLE} \index{AMISH BREAKFAST CASSEROLE}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{\hypertarget{wafflelink}{WAFFLES I}} \index{WAFFLES I}
\name{(quick version)}\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{WAFFLES II} \index{WAFFLES II}
\name{(Joy of Cooking)}\\
