...
My own recipe adapted from the Shambani Cottage cooks at Mombasa \\
	\step{1 lb chicken, beef, or pork, cubed
	\\ 2-3 kg tomatoes, peeled, seeded, and diced
	\\ 1 large onion, diced
	\\ 2 cloves garlic, crushed
	\\ 2 bunches dhania (cilantro)
	\\ 3 Tbsp curry powder
	\\ Cumin, turmeric, cardamom, cloves, ground coriander (cinnamon can be added if desired)
	\\ 1-2 bouillon cubes}{
Stir fry meat in a little oil. Remove from pan and set aside. Add tomatoes, onion, garlic, and dhania to the drippings. 
Saut\'e. If necessary, add a little oil. Add spices and bouillon cube. Let the vegetables and spices simmer until sauce thickens (approx 30 min. Longer if the tomatoes were juicy). Add the cooked meat. This sauce is also good with shrimp or vegetables. Serve over rice with yoghurt, diced banana, mango, papaya, coconut, peanuts, chopped cooked egg, etc.}
...
Melt butter. Add apples, onions and garlic. Cook 5 min. Stir in flour, spices and salt. Slowly blend in milk. Cook and stir until thick. Add chicken. Heat through.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{INDIAN-SPICED PORK CHOPS} \index{INDIAN-SPICED PORK CHOPS}
	\step{2 bay leaves, well crumbled	
	\\ \nicefrac{1}{2} tsp salt
	\\ 1 tsp ground cumin	
	\\ 8 lean rib pork chops
	\\ \nicefrac{1}{2} tsp ground ginger	
	\\ \nicefrac{1}{2} tsp ground coriander
	\\ \nicefrac{1}{4} tsp ground turmeric
	\\ 1 lime, quartered (optional)}{
In a small bowl, combine the spices and salt. Rub mixture on both sides of each pork chop. Cover and marinate at room temperature for 1 hour. Preheat the broiler about 5 min. Place the pork chops on the broiler pan rack and broil 7 or 8 inches from heat, turning 3 or 4 times, until golden and cooked through about 10 min. Garnish with the lime, if desired.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{PAN-FRIED CHICKEN TIKKA} \index{PAN-FRIED CHICKEN TIKKA}
\textit{(Chapel Chakula)}\\
	\step{1 kg chicken pieces	
		\\ 500 mL natural yoghurt
	\\ 2 tsp lemon juice	
	\\ \nicefrac{1}{2} tsp chilli powder (Kenyan variety)
	\\ 1 tsp white pepper	
	\\ 1 tsp black pepper
	...
	\\ 2 Tbsp tomato paste}{
Cut chicken into manageable pieces and make shallow cuts. Mix remaining ingredients in bowl. Add chicken. Cover and refrigerate or keep in cool place overnight. If possible, stir occasionally. Heat a heavy based pan and lightly oil it. Fry the chicken pieces together with some marinade and cook to crisp, turning regularly.}
...
Mix marinade ingredients. Make 3 diagonal cuts \nicefrac{1}{4}-inch deep across top of each chicken breast half. Put chicken in marinade. Cover and refrigerate 8 hours or overnight. Grill chicken 6 min on each side or until chicken is done.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CHICKEN MAKHANI} \index{CHICKEN MAKHANI}
	\step{2 Tbsp lemon juice	
		...
		\\ salt}{
Combine first 6 ingredients and let chicken marinate for a minimum of 30 min.
Heat oil in large saucepan over medium high heat. Saut\'e onion in medium high heat until soft and translucent. Stir in butter, lemon juice, ginger, garlic, and spices. Stir for 1 minute. Add tomato puree and cook for 2 min, stirring frequently. Stir in cream, yoghurt, and cashews. Reduce heat to low and simmer, stirring frequently.
...
\\ Pinch of asafetida	
\\ Pinch of turmeric}{
Rub fish slices with salt and turmeric. Set aside for 5 min. Whisk yoghurt with a little salt. Heat ghee. Fry fish till golden. Heat remaining ghee. Add all spices except chopped coriander. Add yoghurt. Cook till reddish brown. Add fish and water. Simmer 20 min. Add green chilies and fresh coriander. Simmer, covered, 10 min.}
...
Combine ingredients in saucepan. Cover and cook for about 20 min until vegetables are tender. Run through blender or serve as is.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{MASUR DAHL} \index{MASUR DAHL}
\textit{(Bretta Hixson)} \\
	\step{2 cups red lentils	
...
\\ dash cayenne pepper
\\ \nicefrac{1}{3} cup ghee (clarified butter)	
\\ \nicefrac{1}{2} cup chopped fresh cilantro}{
Bring lentils, water, and ginger to a boil in a saucepan. Reduce heat to medium-low and simmer for 10 min. Skim off and discard any scum that forms, then stir in the salt, ginger and turmeric, and simmer until the lentils are tender, about 1 hour more. 
Meanwhile, melt ghee in a large skillet over medium heat. Stir in onions and garlic. Cook and stir until the onions are soft and beginning to brown, about 10 min. Add the coriander, cumin, cayenne pepper, and cilantro. Cook and stir for 2 min more, then set aside. Once the lentils are done, discard the ginger slices, stir in the onion mixture and ladle into bowls to serve.}
...
\\ 12 tsp fenugreek}{Heat oil in frying pan. Add onions, mustard seeds, tomatoes, garlic and spices. Cook for 10 minutes. Stir in remaining ingredients and cover the pan, cook until the potatoes are tender.}
...
Cut potatoes in small cubes. Wash spinach several times. Discard tough stems and steam in covered pot for 10 min, until tender. Do NOT add water. Chop roughly. Save liquid in pan.
In frying pan, heat ghee and fry mustard and cumin seeds until the mustard seeds pop. Cover the pan so that the seeds don't fly all over the stovetop. Add spices and chillies. Add potatoes and fry a few more min. Add spinach liquid, adding water until it reaches the \nicefrac{1}{2} cup mark. Season with salt. Cover and cook 10 min. Add spinach, stir, cover and cook 5-10 min more. Sprinkle nutmeg over the dish and serve.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SAAG} \index{SAAG}
\textit{I (Katrina) was introduced to saag from my North Indian graduate school roommate, Jagjeet Kaur Kapoor, and it quickly became a staple in my Indian cooking. Unlike palak paneer (a spinach dish), saag has a bitterness from the mustard greens. This recipe can be turned into palak paneer by replacing the mustard greens with more spinach.}\\
...
\\ Vegetable oil for brushing on the chapatis}{Stir together salt and flour.  Add the 1 Tbsp of vegetable oil.  Stir in water and knead with fingers until the dough is elastic, approximately 5 minutes. Divide into 4 equal balls.  Roll the ball into a thin circle. Spread \nicefrac{1}{4} tsp oil over it. Roll like a jelly roll, then coil the roll to form a snail. Let dough sit 20 minutes to 8 hrs. (don’t refrigerate) Coil each snail into a 10-12" diameter circle. Place on ungreased hot cast iron skilled (med heat). Flip the chapati when brown spots appear on the underside. Brush the entire surface of the chapatti lightly with oil. Flip when brown spots appear on the other side and chapati has air bubbles. Brush with oil again. Flip for a few seconds and remove from pan.}
...
Everything can be turned into pakora. Jeet's favourite pakora is bread pakora: bread covered with pakora batter and deepfried. Katrina loves paneer pakora: thinly sliced paneer sandwiching a mint chutney, dipped in pakora batter, and deep-fried. Another favourite is a spinach pakora (flash-fried) drizzled with a tamarind sauce.}\\
