...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{VEGETABLE STIR FRY} \index{VEGETABLE STIR FRY}
\step{Vegetables cut for stirfry\\
\nicefrac{1}{4} cup chicken broth\\
2 Tbsp oyster sauce \\
1 \nicefrac{1}{2} tsp rice wine \\
\nicefrac{1}{2} tsp sugar \\
pepper \\
1 tsp cornstarch \\
2 tsp water\\
salt \\
1--2 tsp sesame oil}{Stir fry vegetables. Add remaining ingredients and thicken with cornstarch and water. Finish with sesame oil.}
...
\step{1 Tbsp oil \\
1 lb chicken breast, bitesize pieces\\
2 cloves garlic, minced \\
1 small onion, minced \\
8 oz bihon noodles, vermicelli, or rice noodles \\
1 \nicefrac{1}{2} mixed vegetables (carrots, cabbage, green beans, scallions, etc.), chopped small \\
salt and pepper \\
lemon wedges (opt) \\
\stepspace SAUCE: \\
...
1 Tbsp oyster sauce \\
1 tsp sugar
}{Add oil and chicken to wok. Cook until tender. Remove and set aside. Add garlic and onion and cook for 2 minutes. Add chicken. Season with salt and pepper. Stir in vegetables. Cook 3--4 minutes. Add sauce ingredients to wok and bring to a boil. Add rice noodles and stir until noodles are well-coated. Keep stirring and cooking until noodles are tender (3--4 minutes). Add stock or water as needed. Season with salt and pepper and soy sauce if necessary. Serve immediately with lemon wedges.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GINGER PORK} \index{GINGER PORK}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{JAP CHAE} \index{JAP CHAE}
\name{This very large Korean recipe will easily feed 8--10 people.}\\
...
\name{(Thailand's most well known noodle dish)}\\
	\step{250 g Pad Thai rice sticks or vermicelli\\
	4 Tbsp vegetable oil \\
	1 onion, sliced \\
	...
	3 cups bean sprouts\\
	1 cup very firm tofu, cut in 1" batons \\
	\nicefrac{1}{2} cup garlic chives or onion greens, cut in \nicefrac{1}{4}" pieces \\
	\nicefrac{1}{2} cup peanuts, finely chopped\\
	\stepspace SAUCE: \\
	3 Tbsp tamarind puree or ketchup \\
	6 Tbsp brown sugar \\
	 4 Tbsp fish sauce \\
	3 Tbsp oyster sauce
	}
	{Soak noodles in boiling water for 5 minutes. Drain. Rinse in cold water and use within 5--10 minutes. Mix sauce. Fry garlic and onion. Add chicken and cook for 1~\nicefrac{1}{2} minutes. Push to side of pan. Pour egg in and scramble. Mix into chicken. Add bean sprouts, tofu, noodles. Add sauce. Toss gently for 1~\nicefrac{1}{2} minutes until sauce is absorbed into noodles. Add garlic chives and peanuts. Toss. Serve immediately with lime wedges.}
...
\\ 2 Tbsp sugar	
\\ 1 tsp salt
\\ 2 Tbsp flour}{Saut\'e garlic in enough oil to cover bottom of pan. Then add chopped meat and brown. Add remaining vegetables and pineapple. Cook 2--3 minutes stirring constantly. Mix remaining ingredients. Add sauce. Bring to boil. Add water as necessary.}
