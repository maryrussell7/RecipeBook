...
\begin{minipage}{\linewidth}\rtitle{ROAST BEEF MARINADE} \index{ROAST BEEF MARINADE}
\textit{(Ruth Stalder)}\\
\step{dry mustard	\\
soy sauce \\
	lots of garlic	\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SANTA MARIA TRI TIP DRY RUB} \index{SANTA MARIA TRI TIP DRY RUB}
