...
\begin{minipage}{\linewidth}\rtitle{QUICK INJERA} \index{QUICK INJERA}
\textit{At this time, we have been unable to get a good injera recipe. Just buy it! However, if you are in a bind, you can use this recipe to mediocre results.}\\
\step{2.5 cup Krusteaz buttermilk pancake mix
\\ 2.5 cup warm water	
\\ 1 tsp yeast
\\ 1 Tbsp vinegar per cup of batter}{
Whisk the pancake mix, yeast, and warm water together in a large bowl. Cover and let it sit at least 30 min. It should grow frothy and bubbly over this period. Preheat the oven to 400$^\circ$F. Add vinegar just before cooking. Spray a large pizza pan (14-inch) with a very generous amount of cooking spray, and pour half the batter out in concentric circles starting at the outer part. Cook on a middle rack for 10-12 min or until cooked all the way through and dry to the touch in the center. Note: thicker injera is more likely to break apart when bent, so always err towards making it too thin.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{INJERA} \index{INJERA} \index{Gluten Free}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SPINACH LENTILS} \index{SPINACH LENTILS}
\textit{Not an Ethiopian dish, but can be made Ethiopian. Use niter kibeh instead of vegetable oil.} \\
\step{1\nicefrac{1}{4} pounds fresh or frozen leaf spinach	
\\ 1 cup dried lentils
\\ 1 medium-size onion
...
Cut spinach leaves crosswise into \nicefrac{1}{2}-inch-wide strips. Cut each root into 2 to 3 pieces. If using frozen spinach, cook according to directions, drain and chop coarsely.  Cut the onion into fine half rings.  Heat the oil in a heavy, wide, casserole-type pot over a medium flame. When hot, put in the onion and garlic. Stir and saut\'e for 2 min. Now put in the lentils and 3 cups of water. Bring to a boil. Cover, lower heat and simmer about 25 min or until lentils are just tender. Add the spinach leaves and roots, salt and cumin. Stir to mix and bring to a simmer. Cover and simmer another 10 to 15 min or until spinach is tender and well-mixed into the lentils. Stir gently a few times during this period. Put in the black pepper and mix again.}
