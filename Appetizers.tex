...
{Cut potatoes crosswise into thirds. Use the 2 ends for potato skins and save the middle slices in water for future use. Preheat oven to 425$^\circ$F. Whisk together butter and mustard. Halve each potato piece and hollow out, leave \nicefrac{1}{4} inch shells. Immediately toss the halves in the mustard mixture. Roast, cut side down, on a lightly oiled baking sheet, until nicely browned, 20-30 min. Sprinkle with coarse salt. Turn the potatoes upright and cover with grated cheese. Sprinkle with bacon. At this point, potatoes can be held at room temp for up to 2 hrs before serving. Return potatoes to oven and bake until hot, about 5 min. Garnish with sour cream and onion greens.}
...
{Heat oven to 350$^\circ$F. Remove stems from mushroom caps. Reserve caps. Finely chop enough stems to measure \nicefrac{1}{2} cup. Discard remaining stems. Mix chopped mushroom stems and remaining ingredients in small bowl until well blended. Spoon into mushroom caps, mounding slightly. Place in ungreased pan. Bake 15-20 min or until thoroughly heated. Serve warm.}
...
\step{1 pkg cream cheese, softened	\\
	...
	Ripe olive pieces}
{Mix all ingredients except tortillas and olive pieces. Divide mixture among tortillas, spreading to edges. Roll up tightly. Press each tortilla roll into triangle shape, using fingers. Wrap in plastic wrap. Refrigerate at least 2 hrs but no longer than 24 hrs.
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{HAM AND SWISS APETIZER CHEESECAKE} \index{HAM AND SWISS APETIZER CHEESECAKE} 
\step{1 cup crushed round wheat crackers	\\
...
\nicefrac{1}{2} cup chopped drained roasted red bell peppers\\
2 Tbsp chopped fresh or \nicefrac{1}{2} tsp dried thyme\\
1 pkg assorted crackers
}
{Heat oven to 350$^\circ$F. Mix crushed crackers and butter until well blended. Press in bottom of ungreased 9" springform pan. Bake 8-10 minutes, until golden brown. Beat cream cheese on medium speed until smooth. Add whipping cream and eggs; beat until smooth. Stir in cheese, ham, peppers, onions and thyme. Spoon evenly over crust. Bake 45-55 minutes or until center is set. Run knife around edge of cheesecake to loosen. Cool completely, about 1 hr. Cover and refrigerate at least 2 hrs but no longer than 48 hours.
Remove side of pan. To serve, cut cheesecake into thin wedges. Serve with crackers.}
...
\\ 1 Tbsp brown sugar
\\ 1 \nicefrac{1}{2} tsp lemon juice}{Preheat oven to 350${}^\circ$F. In large bowl, mix beef, egg, water, bread crumbs and onion. Roll into small meatballs. Bake in oven for 20-25 min, turning once. In a slow cooker or large saucepan over low heat, blend cranberry sauce, chili sauce, brown sugar and lemon juice. Add meatballs and simmer for 1 hr before serving.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CHICKEN FINGERS} \index{CHICKEN FINGERS}
	\step{4 chicken breasts, halved. Cut each half into 3 finger length pieces. \\
	 ...
	 \nicefrac{1}{4} tsp thyme}{Combine bread crumbs, herbs and cheese. Dip each chicken finger in butter then coat with crumbs. Place on greased, foil lined baking sheet. Bake for 25-30 min at 400$^\circ$F. Turn at half time.}
...
\textit{(Company's Coming)} \\
	\step{\nicefrac{3}{4} cup Grated parmesan cheese	 \\
	 ...
	 900 g chicken wings}{Mix first 7 ingredients together. Cut off chicken wing tips and discard. Dip wings into melted butter than coat with dry mixture. Arrange on greased, foil lined baking sheet. Bake in 350$^\circ$F oven for 30-45 min until tender.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BARBECUE SAUCED WINGS (GF)} \index{BARBECUE SAUCED WINGS (GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{JAPANESE CHICKEN WINGS (LC*,GF*)} \index{JAPANESE CHICKEN WINGS (LC*,GF*)} \index{Gluten Free!appetizers}
...
Mash cream cheese and salsa together with fork. Set aside. Toss next 4 ingredients in bowl. Spread \nicefrac{1}{2} of each tortilla with cream cheese mixture to \nicefrac{1}{2} inches from edge. Sprinkle green pepper mixture over cream cheese mixture. Sprinkle each with grated cheese. Fold uncovered half over filling. Press edges lightly with your hand. Arrange on ungreased baking sheet. Bake in 425$^\circ$F oven for 10-15 min or toast under broiler. Cut into 4 wedges each. Serve with dipping sauces.}
...
\step
 ...
 48 stuffed olives}{Blend cheese with butter. Add dry ingredients. Mix well. Wrap about 1 tsp of this mixture around olive, covering completely. (This is the tricky bit and can take a bit of patience! I flatten the dough in the palm of my hand and then wrap it. It also helps if the olives are drained well.) Bake at 400$^\circ$ for 15 min on a cookie sheet.}


\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{JALAPENO BACON DEVILED EGGS (LC,GF)} \index{JALAPENO BACON DEVILED EGGS (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
	\step
...
Drop green onion strips in boiling water and cook 10 sec or until limp. Drain and set aside. Combine crabmeat and next 6 ingredients in a medium bowl and stir well. Working with 1 won ton wrapper at a time, cover remaining wrappers with a damp towel, spoon 2 tsps mixture into center of wrapper. Moisten edges of wrapper with egg white. Gather 4 corners of wrapper and crimp to seal, forming a purse. Tie 1 green onion strip around crimped top of purse (like a child's drawstring purse). Repeat with remaining won tons wrappers. Arrange half of won ton purses in a single layer in a vegetable steamer coated with cooking spray. Steam purses, covered, 8 min or until tender. Carefully remove purses from steamer; set aside and keep warm. Repeat with remaining purses. Combine soy sauce, water and 1 Tbsp lemon juice in a small bowl. Stir well. Serve with purses.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SEAFOOD SALAD 'N' STUFFING (LC,GF)} \index{SEAFOOD SALAD 'N' STUFFING (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
\textit{Ideal as salad or as filling for Pita sandwiches.}\\
\step{8-10 oz. sea legs (fake crab), pulled apart into small pieces
...
Combine tomato, minced garlic, basil, parsley, lemon juice, red pepper, salt and pepper. Toss and set aside for at least 3 hrs. Just before serving, toast the bread and rub on one side with cut sides of garlic cloves. Place a small bowl in center of serving platter. Fill bowl with tomato mixture and arrange toast around the bowl. }

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{SURPRISE SPREAD (LC,GF)} \index{SURPRISE SPREAD (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
	\step
	{8 oz. cream cheese	\\
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{CRAB CHEESE DIP (LC,GF)} \index{CRAB CHEESE DIP (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
	\step
	{\nicefrac{1}{2} cup mayonnaise	\\
...
\textit{(Robert Derosiers	from Southern Health)}\\
...
\\ 2 loaves of French bread (not baguettes)}{Cut top of one loaf of bread and hollow it out.  Use the pieces of bread for dipping. Cut up the other loaf for dipping as well. Combine dip ingredients.  Fill hollowed out loaf. Wrap in foil. Put in oven at 350${}^\circ$F for 45-60 min.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{HOT CHILI DIP (LC,GF*)} \index{HOT CHILI DIP (LC,GF*)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
\textit{(Erma Penner)}\\
	\step{250 g cream cheese		\\
	 ...
	 shredded cheddar cheese
		}{Mix cream cheese and sour cream together. Spoon chilli on top of this. Pour salsa on top. Bake at 400$^\circ$F for 20 min. Cover with shredded cheese and bake 5 more min. Serve hot with taco chips.}
		
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GUACAMOLE (LC,GF)} \index{GUACAMOLE (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
\step{4 avocados
\\ 1 tomato
\\ \nicefrac{1}{2} onion
\\ 1 jalape\~no
...
\\ 1-2 garlic cloves
\\ fresh juice of 1-2 limes}{Mash avocados. Finely chop tomato, onion, and jalape\~no. Add all ingredients.}

\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{VEGETABLE DIP (LC,GF)} \index{VEGETABLE DIP (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{TACO DIP (LC,GF)} \index{TACO DIP (LC,GF)} \index{Gluten Free!appetizers} \index{Low Carb!appetizers}
\textit{Makes a nice change from salsa with taco chips.}\\
\step{1 cup mayonnaise \\
1 cup sour cream \\
1 pkg. taco spices}{}
