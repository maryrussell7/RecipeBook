...
\step{20 pitted prunes \\
10 strips smoked bacon, cut in half \\
20 toothpicks, soaked in water for 15 min.}{
...
Oil for frying}{Place diced chicken in large bowl. Sprinkle with salt, pepper and thyme. Cover with buttermilk. Stir to ensure all chicken is coated. Cover and refrigerate for at least 30 minutes. Heat oil in large pot. Meanwhile, ad flour, panko, salt and pepper to a large ziplock bag. Shake to combine. Add in 2--3 Tbsp buttermilk and stir with spoon until breading mixture is clumpy. Use a slotted spoon to transfer chicken into plastic bag. Seal bag and toss to coat chicken. Add chicken, about 8 pieces at a time, to hot oil and fry 4--5 minutes, flipping halfway through. Transfer chicken to a wire cooling rack set over paper towels. Toss fried chicken with sauce.  Place glazed chicken on a parchment paper lined baking sheet and broil 2--3 minutes until extra sticky.  (This last step can be omitted) }
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{HOT CHILI DIP (GF*)} \index{HOT CHILI DIP (GF*)} \index{Gluten Free!appetizers} 
\name{(Erma Penner)}\\
