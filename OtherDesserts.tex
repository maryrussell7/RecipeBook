...
\begin{minipage}{\linewidth}\rtitle{LAVA CAKE (GF)} \index{Gluten Free!desserts} \index{LAVA CAKE (GF)} 
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{BREAD PUDDING (GF*)} \index{BREAD PUDDING (GF*)} \index{Gluten Free!desserts}
...
{Combine sugar, flour and cinnamon and sprinkle over apples. Cover with remaining ingredients. Bake at 400$^\circ$F until brown in a $9 \times 9$" pan. Option: replace apples with rhubarb.}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{GINGERBREAD} \index{GINGERBREAD}
...
\end{minipage}\par\begin{minipage}{\linewidth}\rtitle{ORANGE-CRANBERRY TRIFLE} \index{ORANGE-CRANBERRY TRIFLE}
